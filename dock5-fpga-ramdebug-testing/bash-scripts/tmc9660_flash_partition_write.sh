...
if [[ -z "${TMC9660_PARTITION}" ]]; then
	echo "TMC9660_PARTITION not defined"
	exit 1
fi
...
echo ""
echo "Step #1. Write the Analog Garage Partition Table to the Dock5 Flash."
echo ""
$UBLCLI_TOOL -vv write SPI partition $TMC9660_PARTITION
sleep 1.0
echo ""
echo "End of Script."
echo ""
