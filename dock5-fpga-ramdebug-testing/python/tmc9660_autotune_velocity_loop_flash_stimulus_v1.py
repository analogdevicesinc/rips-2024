...
if args.enable_sine_test:
    ...
    myStimulusFluxReaderClass = StimulusReaderClass(tcml_interface=myInterface, plot_stimulus=args.plot_stimulus, csv_file=args.sine_csv_file, no_timeout=args.no_timeout, verbose=args.verbose)
    ...
    mcchelp.mcc_write(MCC.MOTION_CONFIG, 0x00000002) # Switch to Velocity Mode.
    myMotor.zero_voltageext()
    myMotor.zero_torquefluxtarget()
    myMotor.zero_torquefluxactual()
    myMotor.zero_velocitytarget()
